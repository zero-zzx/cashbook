...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sql="create table accounttb(id integer primary key autoincrement,typename varchar(10),sImageId integer,note varchar(80),money float,time varchar(60),kind integer)";
        sqLiteDatabase.execSQL(sql);
